...
public:
	...
	void align(const Eigen::Matrix<double, 4, 4> &guess);

	void align(typename pcl::PointCloud<PointSourceType> &output, const Eigen::Matrix<double, 4, 4> &guess);
	...
	Eigen::Matrix<double, 4, 4> getFinalTransformation() const;
...
protected:
	...
	virtual void computeTransformation(const Eigen::Matrix<double, 4, 4> &guess);
	...
	Eigen::Matrix<double, 4, 4> final_transformation_, transformation_, previous_transformation_;
