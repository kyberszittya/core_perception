...
template <typename PointSourceType, typename PointTargetType>
Eigen::Matrix<double, 4, 4> Registration<PointSourceType, PointTargetType>::getFinalTransformation() const
{
...
template <typename PointSourceType, typename PointTargetType>
void Registration<PointSourceType, PointTargetType>::align(const Eigen::Matrix<double, 4, 4> &guess)
{
	converged_ = false;

	final_transformation_ = transformation_ = previous_transformation_ = Eigen::Matrix<double, 4, 4>::Identity();
...
template <typename PointSourceType, typename PointTargetType>
void Registration<PointSourceType, PointTargetType>::align(typename pcl::PointCloud<PointSourceType> &output, const Eigen::Matrix<double, 4, 4> &guess)
{
	align(guess);
}

template <typename PointSourceType, typename PointTargetType>
void Registration<PointSourceType, PointTargetType>::computeTransformation(const Eigen::Matrix<double, 4, 4> &guess) {
